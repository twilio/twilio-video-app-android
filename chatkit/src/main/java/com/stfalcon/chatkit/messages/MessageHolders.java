...
public class MessageHolders {
    ...
    public MessageHolders setIncomingImageConfig(
            @NonNull
                    Class<? extends BaseMessageViewHolder<? extends MessageContentType.Image>>
                            holder,
            @LayoutRes int layout) {
    ...
    protected ViewHolder getHolder(
        ...
        switch (viewType) {
            case VIEW_TYPE_DATE_HEADER:
                return getHolder(
                        parent, dateHeaderLayout, dateHeaderHolder, messagesListStyle, null);
                ...
                if (view != null) {
                    view.setOnClickListener(
                            v ->
                                    clickListenersArray
                                            .get(key)
                                            .onMessageViewClick(view, (IMessage) item));
                }
            }
    ...
    private ViewHolder getHolder(
        ...
        return getHolder(
                parent, holderConfig.layout, holderConfig.holder, style, holderConfig.payload);
    }
    ...
    /**
     * The base class for view holders for incoming and outcoming message. You can extend it to
     * create your own holder in conjuction with custom layout or even using default layout.
     */
    ...
    public static class IncomingImageMessageViewHolder<MESSAGE extends MessageContentType.Image>
        ...
        public void onBind(MESSAGE message) {
            ...
            if (image != null && imageLoader != null) {
                imageLoader.loadImage(
                        image, message.getImageUrl(), getPayloadForImageLoader(message));
            }
        ...
        /**
         * Override this method to have ability to pass custom data in ImageLoader for loading
         * image(not avatar).
         *
    ...
    public static class DefaultDateHeaderViewHolder extends ViewHolder<Date>
        ...
        public void onBind(Date date) {
            if (text != null) {
                ...
                text.setText(
                        formattedDate == null
                                ? DateFormatter.format(date, dateFormat)
                                : formattedDate);
            }
        }
        ...
        public void applyStyle(MessagesListStyle style) {
            ...
            dateFormat =
                    dateFormat == null
                            ? DateFormatter.Template.STRING_DAY_MONTH_YEAR.get()
                            : dateFormat;
        }
    }
    ...
    public abstract static class BaseIncomingMessageViewHolder<MESSAGE extends IMessage>
        ...
        public void onBind(MESSAGE message) {
            if (time != null) {
                time.setText(
                        DateFormatter.format(message.getCreatedAt(), DateFormatter.Template.TIME));
            }
