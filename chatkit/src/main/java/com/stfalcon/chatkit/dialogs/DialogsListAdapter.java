...
public class DialogsListAdapter<DIALOG extends IDialog>
    ...
    public void sortByLastMessageDate() {
        Collections.sort(
                items,
                (o1, o2) -> {
                    if (o1.getLastMessage()
                            .getCreatedAt()
                            .after(o2.getLastMessage().getCreatedAt())) {
                        return -1;
    ...
    public abstract static class BaseDialogViewHolder<DIALOG extends IDialog>
        ...
        protected void setOnDialogClickListener(
                OnDialogClickListener<DIALOG> onDialogClickListener) {
            this.onDialogClickListener = onDialogClickListener;
        }
    ...
    public static class DialogViewHolder<DIALOG extends IDialog>
        ...
        private void applyStyle() {
            if (dialogStyle != null) {
                ...
                if (tvName != null) {
                    tvName.setTextSize(
                            TypedValue.COMPLEX_UNIT_PX, dialogStyle.getDialogTitleTextSize());
                }
                ...
                if (ivLastMessageUser != null) {
                    ivLastMessageUser.getLayoutParams().width =
                            dialogStyle.getDialogMessageAvatarWidth();
                    ivLastMessageUser.getLayoutParams().height =
                            dialogStyle.getDialogMessageAvatarHeight();
                }
            ...
            if (dialogStyle != null) {
                ...
                if (tvLastMessage != null) {
                    ...
                    tvLastMessage.setTypeface(
                            Typeface.DEFAULT, dialogStyle.getDialogMessageTextStyle());
                }
            }
        }
        ...
        private void applyUnreadStyle() {
            if (dialogStyle != null) {
                ...
                if (tvName != null) {
                    ...
                    tvName.setTypeface(
                            Typeface.DEFAULT, dialogStyle.getDialogUnreadTitleTextStyle());
                }
        ...
        public void onBind(final DIALOG dialog) {
            ...
            if (dialog.getLastMessage() != null) {
                ...
                tvDate.setText(
                        formattedDate == null ? getDateString(lastMessageDate) : formattedDate);
            } else {
                tvDate.setText(null);
            }
            ...
            container.setOnLongClickListener(
                    view -> {
                        ...
                        return onLongItemClickListener != null
                                || onDialogViewLongClickListener != null;
                    });
        }
