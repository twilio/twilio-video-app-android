    ...
    static DialogListStyle parse(Context context, AttributeSet attrs) {
        ...
        style.dialogTitleTextSize =
                typedArray.getDimensionPixelSize(
                        ...
                        context.getResources()
                                .getDimensionPixelSize(R.dimen.dialog_title_text_size));
        ...
        style.dialogMessageTextSize =
                typedArray.getDimensionPixelSize(
                        ...
                        context.getResources()
                                .getDimensionPixelSize(R.dimen.dialog_message_text_size));
        ...
        style.dialogUnreadBubbleTextSize =
                typedArray.getDimensionPixelSize(
                        ...
                        context.getResources()
                                .getDimensionPixelSize(R.dimen.dialog_unread_bubble_text_size));
        ...
        style.dialogDividerColor =
                typedArray.getColor(
                        R.styleable.DialogsList_dialogDividerColor,
                        style.getColor(R.color.dialog_divider));
        style.dialogDividerLeftPadding =
                typedArray.getDimensionPixelSize(
                        R.styleable.DialogsList_dialogDividerLeftPadding,
                        context.getResources()
                                .getDimensionPixelSize(R.dimen.dialog_divider_margin_left));
        style.dialogDividerRightPadding =
                typedArray.getDimensionPixelSize(
                        R.styleable.DialogsList_dialogDividerRightPadding,
                        context.getResources()
                                .getDimensionPixelSize(R.dimen.dialog_divider_margin_right));
