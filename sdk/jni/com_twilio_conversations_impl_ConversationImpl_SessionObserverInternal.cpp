...
public:
	SessionObserverInternalWrapper(JNIEnv* jni, jobject obj, jobject j_observer, jobject conversation) :
		...
		j_session_state_changed_id(
				GetMethodID(jni, *j_observer_class_, "onSessionStateChanged", "(Lcom/twilio/conversations/impl/core/SessionState;)V")),
		j_start_completed_id(
				GetMethodID(jni, *j_observer_class_, "onStartCompleted", "(Lcom/twilio/conversations/impl/core/CoreError;)V")),
		j_stop_completed_id(
				GetMethodID(jni, *j_observer_class_, "onStopCompleted", "(Lcom/twilio/conversations/impl/core/CoreError;)V")),
		j_participant_connected_id(
				GetMethodID(jni, *j_observer_class_, "onParticipantConnected", "(Ljava/lang/String;Ljava/lang/String;Lcom/twilio/conversations/impl/core/CoreError;)V")),
		j_participant_disconnected_id(
				GetMethodID(jni, *j_observer_class_, "onParticipantDisconnected", "(Ljava/lang/String;Ljava/lang/String;Lcom/twilio/conversations/impl/core/DisconnectReason;)V")),
		j_media_stream_added_id(
				GetMethodID(jni, *j_observer_class_, "onMediaStreamAdded", "(Lcom/twilio/conversations/impl/core/MediaStreamInfo;)V")),
		j_media_stream_removed_id(
				GetMethodID(jni, *j_observer_class_, "onMediaStreamRemoved", "(Lcom/twilio/conversations/impl/core/MediaStreamInfo;)V")),
		j_video_track_added_id_(
				GetMethodID(jni, *j_observer_class_, "onVideoTrackAdded", "(Lcom/twilio/conversations/impl/core/TrackInfo;Lorg/webrtc/VideoTrack;)V")),
		j_video_track_removed_id_(
				GetMethodID(jni, *j_observer_class_, "onVideoTrackRemoved", "(Lcom/twilio/conversations/impl/core/TrackInfo;)V")),
		j_video_track_state_changed_id_(
				GetMethodID(jni, *j_observer_class_, "onVideoTrackStateChanged", "(Lcom/twilio/conversations/impl/core/TrackInfo;)V")),
		j_audio_track_added_id_(
				GetMethodID(jni, *j_observer_class_, "onAudioTrackAdded", "(Lcom/twilio/conversations/impl/core/TrackInfo;Lorg/webrtc/AudioTrack;)V")),
		j_audio_track_removed_id_(
				GetMethodID(jni, *j_observer_class_, "onAudioTrackRemoved", "(Lcom/twilio/conversations/impl/core/TrackInfo;)V")),
		j_audio_track_state_changed_id_(
				GetMethodID(jni, *j_observer_class_, "onAudioTrackStateChanged", "(Lcom/twilio/conversations/impl/core/TrackInfo;)V")),
		j_trackinfo_class_(
