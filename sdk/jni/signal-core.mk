...
LOCAL_SRC_FILES         := $(PREFIX)/twilio-common/android/armeabiv7a/lib/libtwilio-common-full.a
LOCAL_EXPORT_C_INCLUDES := $(PREFIX)/twilio-common/android/armeabiv7a/include
