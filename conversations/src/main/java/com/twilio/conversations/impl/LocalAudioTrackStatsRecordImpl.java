...
public class LocalAudioTrackStatsRecordImpl extends MediaTrackStatsRecordImpl
        implements LocalAudioTrackStatsRecord {
    ...
    public LocalAudioTrackStatsRecordImpl(CoreTrackStatsReport report) {
        super(report);
