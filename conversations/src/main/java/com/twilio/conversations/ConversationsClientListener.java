...
public interface ConversationsClientListener {
	 ...
	 */
	void onFailedToStartListening(ConversationsClient conversationsClient, TwilioConversationsException exception);
	 ...
	 * @param incomingInvite The invitation object.
	 */
	void onIncomingInviteCancelled(ConversationsClient conversationsClient, IncomingInvite incomingInvite);
}
