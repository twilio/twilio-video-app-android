...
#ifndef SIGNAL_SDK_ANDROID_COM_TWILIO_CONVERSATIONS_APPLICATIONFOREGROUNDTRACKER_H
#define SIGNAL_SDK_ANDROID_COM_TWILIO_CONVERSATIONS_APPLICATIONFOREGROUNDTRACKER_H
#ifdef __cplusplus
extern "C" {
#endif
