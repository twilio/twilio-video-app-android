...
#include "com_twilio_rooms_Conversation_SessionObserverInternal.h"
...
#include "com_twilio_rooms_Conversation.h"
...
public:
    SessionObserverInternalWrapper(JNIEnv* jni, jobject obj, jobject j_observer, jobject conversation) :
            ...
            j_track_stats_report_class_(
                    jni, jni->FindClass("com/twilio/rooms/CoreTrackStatsReport")),
            j_session_state_changed_id(
                    GetMethodID(jni,
                                *j_observer_class_,
                                "onSessionStateChanged",
                                "(Lcom/twilio/rooms/SessionState;)V")),
            j_start_completed_id(
                    GetMethodID(jni,
                                *j_observer_class_,
                                "onStartCompleted",
                                "(Lcom/twilio/rooms/CoreError;)V")),
            j_stop_completed_id(
                    GetMethodID(jni,
                                *j_observer_class_,
                                "onStopCompleted",
            ...
            j_participant_connected_id(
                    GetMethodID(jni,
                                *j_observer_class_,
                                ...
                                "(Ljava/lang/String;Ljava/lang/String;Lcom/twilio/rooms/CoreError;)V")),
            j_participant_disconnected_id(
                    GetMethodID(jni,
                                *j_observer_class_,
                                "onParticipantDisconnected",
                                "(Ljava/lang/String;Ljava/lang/String;Lcom/twilio/rooms/DisconnectReason;)V")),
            j_media_stream_added_id(
                    GetMethodID(jni,
                                *j_observer_class_,
                                "onMediaStreamAdded",
                                "(Lcom/twilio/rooms/MediaStreamInfo;)V")),
            ...
            j_video_track_added_id_(
                    GetMethodID(jni,
                                *j_observer_class_,
                                "onVideoTrackAdded",
                                "(Lcom/twilio/rooms/TrackInfo;Lorg/webrtc/VideoTrack;)V")),
            j_video_track_failed_to_add_id_(
                    GetMethodID(jni,
                                *j_observer_class_,
                                "onVideoTrackFailedToAdd",
                                "(Lcom/twilio/rooms/TrackInfo;Lcom/twilio/rooms/CoreError;)V")),
            j_video_track_removed_id_(
                    GetMethodID(jni,
                                *j_observer_class_,
                                "onVideoTrackRemoved",
                                "(Lcom/twilio/rooms/TrackInfo;)V")),
            ...
            j_audio_track_added_id_(
                    GetMethodID(jni,
                                *j_observer_class_,
                                "onAudioTrackAdded",
                                "(Lcom/twilio/rooms/TrackInfo;Lorg/webrtc/AudioTrack;)V")),
            ...
            j_receive_track_statistics_id_(
                    GetMethodID(jni, *j_observer_class_, "onReceiveTrackStatistics", "(Lcom/twilio/rooms/CoreTrackStatsReport;)V")),
            ...
            j_trackinfo_class_(
                    jni, jni->FindClass("com/twilio/rooms/TrackInfo")),
            j_trackorigin_class_(
                    jni, jni->FindClass("com/twilio/rooms/TrackOrigin")),
            j_sessionstate_enum_(
                    jni, jni->FindClass("com/twilio/rooms/SessionState")),
            j_trackinfo_ctor_id_(
                    GetMethodID(jni,
                                *j_trackinfo_class_,
                                "<init>",
                                "(Ljava/lang/String;Ljava/lang/String;Lcom/twilio/rooms/TrackOrigin;Z)V")),
            ...
            j_audio_track_ctor_(
                    GetMethodID(jni,
                                *j_audio_track_class_,
                                ...
                                "(J)V")),
            j_errorimpl_class_(
                    jni, jni->FindClass("com/twilio/rooms/CoreError")),
            ...
            j_disreason_enum_(
                    jni, jni->FindClass("com/twilio/rooms/DisconnectReason")),
            j_media_stream_info_class_(
                    jni, jni->FindClass("com/twilio/rooms/MediaStreamInfo")),
...
protected:
    ...
    virtual void onStateDidChange(TSCSessionState state) {
        ...
        const std::string session_state_class = "com/twilio/rooms/SessionState";
    ...
    virtual void onParticipantDidDisconnect(const std::string participant,
        ...
        const std::string dis_reason_class =
                "com/twilio/rooms/DisconnectReason";
...
private:
    ...
    jobject TrackInfoToJavaTrackInfoImpl(const TSCVideoTrackInfoObject *trackInfo) {
        ...
        const std::string state_class = "com/twilio/rooms/TrackOrigin";
 ...
 * Signature: (Lcom/twilio/rooms/SessionObserver;Lcom/twilio/rooms/Conversation;)J
 */
