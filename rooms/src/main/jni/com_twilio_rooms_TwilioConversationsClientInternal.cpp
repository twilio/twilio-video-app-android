...
#include "com_twilio_rooms_TwilioConversationsClientInternal.h"
...
JNIEXPORT jlong JNICALL Java_com_twilio_rooms_TwilioConversationsClientInternal_nativeCreateEndpoint
