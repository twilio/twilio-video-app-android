#include "com_twilio_rooms_TwilioConversationsClientInternal_EndpointObserverInternal.h"
            ...
            :j_endpoint_observer_(env, j_endpoint_observer),
             ...
             j_state_change_(
                     GetMethodID(env,
                                 *j_observer_class_,
                                 "onStateDidChange",
                                 "(Lcom/twilio/rooms/EndpointState;)V")),
             j_incoming_call_(
                     GetMethodID(env,
                                 *j_observer_class_,
             ...
             j_statetype_enum_(
                     env, env->FindClass("com/twilio/rooms/EndpointState")),
             j_errorimpl_class_(
                     env, env->FindClass("com/twilio/rooms/CoreError")),
...
protected:
    ...
    virtual void onStateDidChange(TSCEndpointState state){
        ...
        const std::string state_type_enum = "com/twilio/rooms/EndpointState";
 ...
 * Signature: (Lcom/twilio/rooms/EndpointObserver;Lcom/twilio/rooms/Endpoint;)J
 */
JNIEXPORT jlong JNICALL Java_com_twilio_rooms_TwilioConversationsClientInternal_00024EndpointObserverInternal_nativeWrapObserver
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_twilio_rooms_TwilioConversationsClientInternal_00024EndpointObserverInternal_nativeFreeObserver
