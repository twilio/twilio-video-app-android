...
public class Camera2CapturerUnitTest {
  ...
  public void setup() throws Exception {
    ...
    when(cameraManager.getCameraCharacteristics(cameraIds[0])).thenReturn(cameraCharacteristics);
    when(cameraManager.getCameraCharacteristics(cameraIds[1])).thenReturn(cameraCharacteristics);
