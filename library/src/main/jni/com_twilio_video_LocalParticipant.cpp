...
JNIEXPORT void JNICALL Java_com_twilio_video_LocalParticipant_nativeAddAudioTrack(JNIEnv *jni,
    ...
    local_participant->addTrack(audio_track);
}

JNIEXPORT void JNICALL Java_com_twilio_video_LocalParticipant_nativeAddVideoTrack(JNIEnv *jni,
                                                                                  jobject j_local_participant,
                                                                                  jlong j_local_participant_handle,
                                                                                  jlong j_video_track_handle) {
    auto local_participant = getLocalParticipant(j_local_participant_handle);
    auto video_track = getLocalVideoTrack(j_video_track_handle);
    local_participant->addTrack(video_track);
}

JNIEXPORT void JNICALL Java_com_twilio_video_LocalParticipant_nativeRemoveAudioTrack(JNIEnv *jni,
                                                                                     jobject j_local_participant,
                                                                                     jlong j_local_participant_handle,
                                                                                     jlong j_audio_track_handle) {
    auto local_participant = getLocalParticipant(j_local_participant_handle);
    auto audio_track = getLocalAudioTrack(j_audio_track_handle);
    local_participant->removeTrack(audio_track);
}

JNIEXPORT void JNICALL Java_com_twilio_video_LocalParticipant_nativeRemoveVideoTrack(JNIEnv *jni,
                                                                                     jobject j_local_participant,
                                                                                     jlong j_local_participant_handle,
                                                                                     jlong j_video_track_handle) {
    auto local_participant = getLocalParticipant(j_local_participant_handle);
    auto video_track = getLocalVideoTrack(j_video_track_handle);
    local_participant->removeTrack(video_track);
}
