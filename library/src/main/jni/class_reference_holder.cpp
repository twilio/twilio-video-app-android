...
ClassReferenceHolder::ClassReferenceHolder(JNIEnv* jni) {
    ...
    LoadClass(jni, "com/twilio/video/LocalDataTrack");
    ...
    LoadClass(jni, "com/twilio/video/LocalParticipant");
    ...
    LoadClass(jni, "com/twilio/video/LocalDataTrackPublication");
    LoadClass(jni, "com/twilio/video/RemoteVideoTrack");
    LoadClass(jni, "com/twilio/video/RemoteDataTrack");
    LoadClass(jni, "com/twilio/video/RemoteVideoTrackPublication");
    LoadClass(jni, "com/twilio/video/RemoteDataTrackPublication");
