...
public class LocalParticipant implements Participant {
      ...
      new Listener() {
        ...
        public void onAudioTrackPublicationFailed(
          ...
          checkPublicationFailedCallback(
              localParticipant, localAudioTrack, twilioException, "onAudioTrackPublicationFailed");
        ...
        public void onVideoTrackPublicationFailed(
            ...
            final TwilioException twilioException) {
          checkPublicationFailedCallback(
              localParticipant, localVideoTrack, twilioException, "onVideoTrackPublicationFailed");
        ...
        public void onDataTrackPublicationFailed(
            ...
            final TwilioException twilioException) {
          checkPublicationFailedCallback(
              localParticipant, localDataTrack, twilioException, "onDataTrackPublicationFailed");
        ...
        private void checkPublishedCallback(
            LocalParticipant localParticipant, TrackPublication trackPublication, String callback) {
          Preconditions.checkState(
              localParticipant != null, "Received null local participant in %s", callback);
          Preconditions.checkState(
   ...
   *
   * @return true if the audio track published or false if the local participant is not connected or
   *     the track was already published.
   */
  public synchronized boolean publishTrack(@NonNull LocalAudioTrack localAudioTrack) {
    ...
    if (isReleased()) {
      ...
      return nativePublishAudioTrack(
          nativeLocalParticipantHandle, localAudioTrack, localAudioTrack.getNativeHandle());
    }
  }
  ...
  public synchronized boolean publishTrack(@NonNull LocalVideoTrack localVideoTrack) {
    ...
    if (isReleased()) {
      ...
      return nativePublishVideoTrack(
          nativeLocalParticipantHandle, localVideoTrack, localVideoTrack.getNativeHandle());
    }
  }
   ...
   *
   * @return true if the data track was published or false if the local participant is not connected
   ...
   *
   * @return true if video track was unpublished or false if the local participant is not connected
   *     or could not unpublish video track.
   */
   ...
   *
   * @param encodingParameters The {@link EncodingParameters} to use or {@code null} for the default
   *     values.
   */
  ...
  public interface Listener {
    /**
     * This method notifies the listener that a {@link LocalAudioTrack} has been shared to a {@link
     * Room}.
     *
    ...
    void onAudioTrackPublished(
        LocalParticipant localParticipant, LocalAudioTrackPublication localAudioTrackPublication);
     ...
     * @param twilioException An exception explaining why the local participant failed to publish
    ...
    /**
     * This method notifies the listener that a {@link LocalVideoTrack} has been shared to a {@link
     * Room}.
     *
    ...
    void onVideoTrackPublished(
        LocalParticipant localParticipant, LocalVideoTrackPublication localVideoTrackPublication);
    ...
    /**
     * This method notifies the listener that a {@link LocalDataTrack} has been shared to a {@link
     * Room}.
     *
  ...
  private native boolean nativeUnpublishAudioTrack(long nativeHandle, long nativeAudioTrackHandle);

  private native boolean nativeUnpublishVideoTrack(long nativeHandle, long nativeVideoTrackHandle);
