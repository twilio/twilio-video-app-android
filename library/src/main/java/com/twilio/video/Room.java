...
public class Room {
  ...
  /**
   * Returns the current local participant. If the room has not reached {@link RoomState#CONNECTED}
  ...
  public interface Listener {
     ...
     *     disconnected from. This value will be null is there were no problems disconnecting from
     *     the room.
     */
    ...
    /**
     * Called when a participant has disconnected from a room. The disconnected participant's audio
     * and video tracks will still be available in their last known state. Video tracks renderers
     * are removed when a participant is disconnected.
     *
