...
public class ConnectOptions {
  ...
  public static class Builder {
     ...
     * negotiating audio between participants. The preferences are applied in the order found in the
     * list starting with the most preferred audio codec to the least preferred audio codec. Audio
     * codec preferences are not guaranteed to be satisfied because not all participants are
     * guaranteed to support all audio codecs. {@link OpusCodec} is the default audio codec if no
     * preferences are set.
     *
     ...
     * </code></pre>
     *
     * <p>The following snippet demonstrates how to specify the exact order of codec preferences.
     *
     * <pre><code>
     *     ConnectOptions connectOptions = new ConnectOptions.Builder(token)
     ...
     * negotiating video between participants. The preferences are applied in the order found in the
     * list starting with the most preferred video codec to the least preferred video codec. Video
     * codec preferences are not guaranteed to be satisfied because not all participants are
     * guaranteed to support all video codecs. {@link Vp8Codec} is the default video codec if no
     * preferences are set.
     *
