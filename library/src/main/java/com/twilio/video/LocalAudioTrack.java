...
public class LocalAudioTrack extends AudioTrack {
  ...
  /**
   * Creates an audio track. Note that the RECORD_AUDIO permission must be granted in order for this
   * operation to succeed. If RECORD_AUDIO is not granted null is returned.
   *
