...
public class DataTrackOptions {
  ...
  public static class Builder {
     ...
     *
     * <p>Max packet life time and max retransmits are mutually exclusive. This means that only one
     * of these values can be set to a non default value at a time otherwise a {@link
