...
public class LocalDataTrack extends DataTrack {
  ...
  public static LocalDataTrack create(
    ...
    dataTrackOptions =
        dataTrackOptions == null ? (DataTrackOptions.DEFAULT_DATA_TRACK_OPTIONS) : dataTrackOptions;
  ...
  public synchronized void send(@NonNull ByteBuffer messageBuffer) {
    ...
    nativeBufferSend(
        ...
        messageBuffer.hasArray() ? messageBuffer.array() : getMessageByteArray(messageBuffer));
  }
