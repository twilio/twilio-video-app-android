...
public class LocalAudioTrackTest extends BaseVideoTest {
  ...
  public void canCreateAudioTrackWithOptions() {
    ...
    for (AudioOptions audioOptions : audioOptionsList) {
      ...
      assertNotNull(
          "Failed to create RemoteAudioTrack with options: " + audioOptions, localAudioTrack);
      assertTrue(
      ...
      AudioOptions audioOptions =
          new AudioOptions.Builder()
              ...
              .audioJitterBufferFastAccelerate(
                  audioOptionsMatrix[i][AUDIO_JITTER_BUFFER_FAST_ACCELERATE_INDEX])
  ...
  private boolean[][] getAudioOptionsPermutationMatrix() {
    boolean[][] audioOptionsMatrix = new boolean[NUM_AUDIO_OPTIONS_PERMUTATIONS][NUM_AUDIO_OPTIONS];
