...
public class LocalVideoTrackVideoConstraintsParameterizedTest extends BaseVideoTest {
  ...
  private static final VideoFormat hd720p30fpsVideoFormat =
      new VideoFormat(VideoDimensions.HD_720P_VIDEO_DIMENSIONS, 30, VideoPixelFormat.RGBA_8888);
  ...
  private static final VideoFormat hd720p24fpsVideoFormat =
      new VideoFormat(VideoDimensions.HD_720P_VIDEO_DIMENSIONS, 24, VideoPixelFormat.RGBA_8888);

  private static final List<VideoFormat> formats30Fps =
      Arrays.asList(cif30FpsVideoFormat, vga30FpsVideoFormat, hd720p30fpsVideoFormat);
  private static final List<VideoFormat> formats4by3Ratio30Fps =
      Arrays.asList(
  ...
  private static final List<VideoFormat> formats24Fps =
      Arrays.asList(cif24FpsVideoFormat, vga24FpsVideoFormat, hd720p24fpsVideoFormat);
  private static final List<VideoFormat> galaxyS5BackCameraSupportedFormats =
      Arrays.asList(
  ...
  private static final VideoConstraints vgaMax24FpsMaxConstraints =
      new VideoConstraints.Builder()
          .maxFps(24)
          .maxVideoDimensions(VideoDimensions.VGA_VIDEO_DIMENSIONS)
          .build();
  private static final VideoConstraints vgaMax30FpsMaxConstraints =
      new VideoConstraints.Builder()
          .maxFps(30)
          .maxVideoDimensions(VideoDimensions.VGA_VIDEO_DIMENSIONS)
          .build();
  private static final VideoConstraints vgaMax60FpsMaxConstraints =
      new VideoConstraints.Builder()
          .maxFps(60)
          .maxVideoDimensions(VideoDimensions.VGA_VIDEO_DIMENSIONS)
          .build();
  private static final VideoConstraints vgaMin30FpsMaxConstraints =
      new VideoConstraints.Builder()
          .minFps(30)
          .maxFps(30)
          .maxVideoDimensions(VideoDimensions.VGA_VIDEO_DIMENSIONS)
          .build();
  private static final VideoConstraints minWidth1920Constraints =
      new VideoConstraints.Builder()
          .minVideoDimensions(new VideoDimensions(1920, 480))
          .maxVideoDimensions(new VideoDimensions(1920, 480))
          .build();
  private static final VideoConstraints minHeight1920Constraints =
      new VideoConstraints.Builder()
          .minVideoDimensions(new VideoDimensions(640, 1920))
          .maxVideoDimensions(new VideoDimensions(640, 1920))
          .build();
  private static final VideoConstraints maxWidth288Constraints =
      new VideoConstraints.Builder().maxVideoDimensions(new VideoDimensions(288, 480)).build();
  private static final VideoConstraints maxHeight144Constraints =
      new VideoConstraints.Builder().maxVideoDimensions(new VideoDimensions(640, 144)).build();
  ...
  private static final VideoConstraints aspectRatio16by9Constraints =
      new VideoConstraints.Builder().aspectRatio(new AspectRatio(16, 9)).build();
        ...
        new Object[][] {
          {
            ...
            new TestParameters(null, videoCapturer30Fps, LocalVideoTrack.DEFAULT_VIDEO_CONSTRAINTS)
          },
          {
          ...
          },
          {
            ...
            new TestParameters(
                minWidth1920Constraints, videoCapturer24Fps, vgaMax24FpsMaxConstraints)
          },
          {
            "Capturer does not support max width constraint",
            new TestParameters(
                maxWidth288Constraints, videoCapturer24Fps, vgaMax24FpsMaxConstraints)
          },
          {
            "Capturer does not support minimum height constraint",
            new TestParameters(
                minHeight1920Constraints, videoCapturer24Fps, vgaMax24FpsMaxConstraints)
          },
          {
            "Capturer does not support max height constraint",
            new TestParameters(
                maxHeight144Constraints, videoCapturer24Fps, vgaMax24FpsMaxConstraints)
          },
          {
            "Capturer does not support minimum FPS constraint",
            new TestParameters(
                vgaMin30FpsMaxConstraints, videoCapturer24Fps, vgaMax24FpsMaxConstraints)
          },
          {
            "Capturer does not support max FPS constraint",
            new TestParameters(
                vgaMax60FpsMaxConstraints,
                videoCapturer30Fps,
          ...
          },
          {
            ...
            new TestParameters(
                vgaMax24FpsMaxConstraints, videoCapturer30Fps, vgaMax24FpsMaxConstraints)
          }
        });
  }
  ...
  public LocalVideoTrackVideoConstraintsParameterizedTest(
      String testScenario, TestParameters testParameters) {
  ...
  public void setup() throws InterruptedException {
    ...
    localVideoTrack = LocalVideoTrack.create(context, true, videoCapturer, videoConstraints);
  }
