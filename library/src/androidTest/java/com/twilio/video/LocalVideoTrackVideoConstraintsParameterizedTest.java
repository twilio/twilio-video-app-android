...
public class LocalVideoTrackVideoConstraintsParameterizedTest extends BaseVideoTest {
    ...
    private static final VideoFormat hd720p30fpsVideoFormat =
            new VideoFormat(
                    VideoDimensions.HD_720P_VIDEO_DIMENSIONS, 30, VideoPixelFormat.RGBA_8888);
    ...
    private static final VideoFormat hd720p24fpsVideoFormat =
            new VideoFormat(
                    VideoDimensions.HD_720P_VIDEO_DIMENSIONS, 24, VideoPixelFormat.RGBA_8888);
    ...
    private static final List<VideoFormat> formats4by3Ratio30Fps =
            Arrays.asList(
                    ...
                    vga30FpsVideoFormat,
                    new VideoFormat(
                            new VideoDimensions(1280, 960), 30, VideoPixelFormat.RGBA_8888));
                ...
                new Object[][] {
                    {
                        ...
                        new TestParameters(
                                null, videoCapturer30Fps, LocalVideoTrack.DEFAULT_VIDEO_CONSTRAINTS)
                    },
                    {
