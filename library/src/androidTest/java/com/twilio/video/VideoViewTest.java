...
public class VideoViewTest extends BaseVideoTest {
  ...
  public void canBeRenderedInRecyclerView() throws InterruptedException {
    ...
    localVideoTrack = LocalVideoTrack.create(videoViewTestActivity, true, new FakeVideoCapturer());
    ...
    for (int i = 0; i < numItems; i++) {
      ...
      assertTrue(videoViewHolder.frameCountProxyRendererListener.waitForFrame(FRAME_DELAY_MS));
    }
  }
