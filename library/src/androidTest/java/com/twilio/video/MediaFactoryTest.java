...
public class MediaFactoryTest extends BaseVideoTest {
  ...
  public void createVideoTrack_shouldNotAllowNullContext() {
    mediaFactory.createVideoTrack(
        null, true, new FakeVideoCapturer(), LocalVideoTrack.DEFAULT_VIDEO_CONSTRAINTS, null);
  }
  ...
  public void createVideoTrack_shouldFailAfterAllTracksHaveBeenReleased() {
    ...
    mediaFactory.createVideoTrack(
        context, true, new FakeVideoCapturer(), LocalVideoTrack.DEFAULT_VIDEO_CONSTRAINTS, null);
  }
