  ...
  public void shouldCaptureAndRenderFrame(
    ...
    List<VideoFormat> videoFormats =
        Collections.singletonList(
            new VideoFormat(VideoDimensions.VGA_VIDEO_DIMENSIONS, 30, videoPixelFormat));
    FakeVideoCapturer fakeVideoCapturer = new FakeVideoCapturer(videoFormats, rotationAngle);
    localVideoTrack =
        LocalVideoTrack.create(InstrumentationRegistry.getContext(), true, fakeVideoCapturer);
