  ...
  public static Map<String, String> resolveCredentials(Environment environment) {
    ...
    switch (environment) {
      case DEV:
        ...
        credentials.put(API_KEY_SECRET, BuildConfig.twilioCredentials.get(DEV_API_KEY_SECRET));
        break;
      case STAGE:
        ...
        credentials.put(API_KEY_SECRET, BuildConfig.twilioCredentials.get(STAGE_API_KEY_SECRET));
