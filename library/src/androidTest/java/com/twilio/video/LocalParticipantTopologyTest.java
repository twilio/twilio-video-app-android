...
public class LocalParticipantTopologyTest extends BaseVideoTest {
  ...
  public void shouldFailToPublishTrackWithNameTooLong() throws InterruptedException {
    ...
    localVideoTrack =
        LocalVideoTrack.create(
            mediaTestActivity, true, new FakeVideoCapturer(), random(TRACK_NAME_LENGTH_MAX + 1));
  ...
  public void publishTrack_shouldFailWithTrackNameTooLong() throws InterruptedException {
    ...
    // Validate callbacks
    assertTrue(
        localParticipantListener.onAudioTrackPublicationFailedLatch.await(20, TimeUnit.SECONDS));
    assertTrue(
        localParticipantListener.onVideoTrackPublicationFailedLatch.await(20, TimeUnit.SECONDS));
    assertTrue(
        localParticipantListener.onDataTrackPublicationFailedLatch.await(20, TimeUnit.SECONDS));
