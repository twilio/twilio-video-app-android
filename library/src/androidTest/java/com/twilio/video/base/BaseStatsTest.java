...
public abstract class BaseStatsTest extends BaseVideoTest {
  ...
  protected Room createRoom(String token, CallbackHelper.FakeRoomListener listener, String roomName)
      throws InterruptedException {
  ...
  protected Room createRoom(CallbackHelper.FakeRoomListener listener, ConnectOptions connectOptions)
      throws InterruptedException {
