...
public abstract class BaseCodecTest extends BaseStatsTest {
  ...
  protected void assertCodecsPublished(
    ...
    do {
      ...
      CallbackHelper.FakeStatsListener bobStatsListener = new CallbackHelper.FakeStatsListener();
      ...
      failedToGetNeededCodecs =
          (expectedAudioCodec != null && StringUtils.isNullOrEmpty(localAudioTrackCodec))
              || (expectedAudioCodec != null && StringUtils.isNullOrEmpty(remoteAudioTrackCodec))
              || (expectedVideoCodec != null && StringUtils.isNullOrEmpty(localVideoTrackCodec))
              || (expectedVideoCodec != null && StringUtils.isNullOrEmpty(remoteVideoTrackCodec));
