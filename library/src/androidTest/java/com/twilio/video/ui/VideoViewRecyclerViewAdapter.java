...
public class VideoViewRecyclerViewAdapter
  ...
  public VideoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.video_view_item, null);
  ...
  public class VideoViewHolder extends RecyclerView.ViewHolder {
    ...
    VideoViewHolder(View itemView) {
      ...
      this.frameCountProxyRendererListener =
          new FrameCountProxyRendererListener((VideoView) itemView.findViewById(R.id.video_view));
