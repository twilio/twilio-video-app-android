...
public class ScreenCapturerTest extends BaseVideoTest {
                        ...
                        () -> {
                            ...
                            screenVideoTrack =
                                    LocalVideoTrack.create(
                                            screenCapturerActivity, true, screenCapturer);
    ...
    public void canBeReused() throws InterruptedException {
        ...
        assumeFalse(
                DeviceUtils.isNexus9() && Build.VERSION.SDK_INT == Build.VERSION_CODES.LOLLIPOP);
        int reuseCount = 2;
        ...
        for (int i = 0; i < reuseCount; i++) {
            ...
            assertTrue(
                    firstFrameReceived
                            .get()
                            .await(SCREEN_CAPTURER_DELAY_MS, TimeUnit.MILLISECONDS));
