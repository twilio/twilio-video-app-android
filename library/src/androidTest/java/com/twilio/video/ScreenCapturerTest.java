...
public class ScreenCapturerTest extends BaseVideoTest {
  ...
  public void getSupportedFormats_shouldReturnDimensionsBasedOnScreenSize() {
    ...
    VideoDimensions expectedDimensions =
  ...
  public void shouldRaiseErrorOnListenerIfMediaProjectionCannotBeAccessed()
    ...
    screenCapturer =
        new ScreenCapturer(
            screenCapturerActivity, Integer.MIN_VALUE, new Intent(), screenCapturerListener);
    screenVideoTrack = LocalVideoTrack.create(screenCapturerActivity, true, screenCapturer);
              ...
              public void run() {
                ...
                screenCapturer =
                    new ScreenCapturer(
                        ...
                        screenCapturerListener);
                screenVideoTrack =
                    LocalVideoTrack.create(screenCapturerActivity, true, screenCapturer);
  ...
  public void canBeRenderedToView() throws InterruptedException {
    final VideoView localVideo =
        (VideoView) screenCapturerActivity.findViewById(R.id.screen_capture_video);
  ...
  public void canBeReused() throws InterruptedException {
    ...
    assumeFalse(DeviceUtils.isNexus9() && Build.VERSION.SDK_INT == Build.VERSION_CODES.LOLLIPOP);
    int reuseCount = 2;
    ...
    for (int i = 0; i < reuseCount; i++) {
      ...
      assertTrue(firstFrameReceived.get().await(SCREEN_CAPTURER_DELAY_MS, TimeUnit.MILLISECONDS));
