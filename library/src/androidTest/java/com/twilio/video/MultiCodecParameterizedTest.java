...
public class MultiCodecParameterizedTest extends BaseCodecTest {
  ...
  public static Iterable<Object[]> data() {
    return Arrays.asList(
        new Object[][] {
          {Collections.singletonList(vp8Codec), Collections.singletonList(vp8Codec), vp8Codec},
          {
            Collections.singletonList(vp8WithSimulcastCodec),
            Collections.singletonList(vp8WithSimulcastCodec),
            vp8WithSimulcastCodec
          },
          {Collections.singletonList(vp8Codec), Arrays.asList(vp8Codec, h264Codec), vp8Codec},
          {
            Collections.singletonList(vp8WithSimulcastCodec),
            Arrays.asList(vp8WithSimulcastCodec, h264Codec),
            vp8WithSimulcastCodec
          },
          {Arrays.asList(vp8Codec, h264Codec), Collections.singletonList(vp8Codec), vp8Codec},
          {
            Arrays.asList(vp8WithSimulcastCodec, h264Codec),
            Collections.singletonList(vp8WithSimulcastCodec),
            vp8WithSimulcastCodec
          },
          {Arrays.asList(vp8Codec, h264Codec), Collections.singletonList(h264Codec), h264Codec},
          {
            Arrays.asList(vp8WithSimulcastCodec, h264Codec),
            Collections.singletonList(h264Codec),
            h264Codec
          },
          {Arrays.asList(vp8Codec, h264Codec), Arrays.asList(vp8Codec, h264Codec), vp8Codec},
          {
            Arrays.asList(vp8WithSimulcastCodec, h264Codec),
            Arrays.asList(vp8WithSimulcastCodec, h264Codec),
            vp8WithSimulcastCodec
          },
          {Arrays.asList(h264Codec, vp8Codec), Collections.singletonList(vp8Codec), vp8Codec},
          {
            Arrays.asList(h264Codec, vp8WithSimulcastCodec),
            Collections.singletonList(vp8WithSimulcastCodec),
            vp8WithSimulcastCodec
          },
          {Arrays.asList(h264Codec, vp8Codec), Collections.singletonList(h264Codec), h264Codec},
          {
            Arrays.asList(h264Codec, vp8WithSimulcastCodec),
            Collections.singletonList(h264Codec),
            h264Codec
          },
          {Arrays.asList(h264Codec, vp8Codec), Arrays.asList(vp8Codec, h264Codec), h264Codec},
          {
            Arrays.asList(h264Codec, vp8WithSimulcastCodec),
            Arrays.asList(vp8WithSimulcastCodec, h264Codec),
            h264Codec
