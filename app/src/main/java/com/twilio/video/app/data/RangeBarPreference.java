  ...
  public void onBindViewHolder(PreferenceViewHolder holder) {
    ...
    rangeBar.setLayoutParams(
        new LinearLayout.LayoutParams(
            LinearLayout.LayoutParams.MATCH_PARENT, resources.getDimensionPixelSize(heightResId)));
  ...
  private void init(Context context, @Nullable AttributeSet attrs) {
    ...
    if (attrs != null) {
      TypedArray stylables =
          context.getTheme().obtainStyledAttributes(attrs, R.styleable.RangeBarPreference, 0, 0);
