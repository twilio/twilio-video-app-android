...
import com.tw.rooms.testapp.adapter.RemoteVideoTrackStatsAdapter;
import com.tw.rooms.testapp.dialog.Dialog;
import com.tw.rooms.testapp.model.OptionModel;
import com.tw.rooms.testapp.ui.IceOptionsUI;
import com.tw.rooms.testapp.util.ParticipantParser;
import com.tw.rooms.testapp.util.SimpleSignalingUtils;
import com.twilio.common.AccessManager;
import com.twilio.rooms.AspectRatio;
import com.twilio.rooms.AudioOutput;
import com.twilio.rooms.AudioTrack;
...
import com.twilio.rooms.Conversation;
import com.twilio.rooms.ConversationCallback;
import com.twilio.rooms.IceOptions;
import com.twilio.rooms.IncomingInvite;
import com.twilio.rooms.LocalAudioTrackStatsRecord;
import com.twilio.rooms.LocalMedia;
import com.twilio.rooms.LocalVideoTrack;
import com.twilio.rooms.LocalVideoTrackStatsRecord;
import com.twilio.rooms.MediaTrack;
import com.twilio.rooms.MediaTrackStatsRecord;
import com.twilio.rooms.OutgoingInvite;
import com.twilio.rooms.Participant;
import com.twilio.rooms.RemoteAudioTrackStatsRecord;
import com.twilio.rooms.RemoteVideoTrackStatsRecord;
import com.twilio.rooms.StatsListener;
import com.twilio.rooms.TwilioConversationsClient;
import com.twilio.rooms.TwilioConversationsException;
import com.twilio.rooms.VideoConstraints;
import com.twilio.rooms.VideoDimensions;
import com.twilio.rooms.VideoRenderer;
import com.twilio.rooms.VideoScaleType;
import com.twilio.rooms.VideoTrack;
import com.twilio.rooms.VideoViewRenderer;
...
public class ClientActivity extends AppCompatActivity {
    ...
    private IceOptionsUI iceOptionsUI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            optionModel = new OptionModel(savedInstanceState);
            ...
            optionModel = new OptionModel(extras);
        }

        iceOptionsUI = new IceOptionsUI(this, optionModel);
        ...
        preferH264Checkbox.setChecked(optionModel.isPreferH264());
        ...
        ClientOptionsInternal options = optionModel.createClientOptionsInternal();
    ...
    private IceOptions createIceOptions() {
        if (iceOptionsUI.isEnabled()) {
            return optionModel.createIceOptions(
                    iceOptionsUI.getSelectedIceServers(),
                    iceOptionsUI.getSelectedTransportPolicy());
        }
        return null;
    }
}
